...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured fertilizer</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab"> New Fertilizer</a></li>
					<li><a href="#furniture" data-toggle="tab"> New Tools</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="tab-pane" id="books">
		...
		<?php
$ret=mysql_query("select * from products where category=7");
while ($row=mysql_fetch_array($ret)) 
{
	# code...
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Fertilizer</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysql_query("select * from products where category=8");
while ($row=mysql_fetch_array($ret)) 
{
?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Tools</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysql_query("select * from products where category=9");
while ($row=mysql_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Rakesh</h3>
